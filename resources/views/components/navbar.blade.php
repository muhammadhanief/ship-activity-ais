                ...
                <div class="items-center hidden lg:flex">
                    ...
                    <div class="-mb-1">
                        <a class="github-button" href="https://github.com/themesberg/windster-tailwind-css-dashboard"
                            ...
                            aria-label="Star themesberg/windster-tailwind-css-dashboard on GitHub" hidden>Star</a>
                    </div>
                </div>
                {{-- <a href="#"
                    class=" sm:inline-flex ml-5 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
                    <svg hidden class="w-4 h-4 mr-2 -ml-1 svg-inline--fa fa-gem" aria-hidden="true" focusable="false"
